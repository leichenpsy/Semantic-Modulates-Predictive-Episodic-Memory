...
coverTaskAccQModel <- lmer(acc ~ type * predictType  + (1|subject), data = coverTaskAccQ)
...
hit_0_subject <- c(1,3,4,6,8, 11, 16, 18, 24, 26, 27, 28, 29, 30, 33, 34, 39, 40)
