...
// var imagePath = 'https://run.pavlovia.org/leipsy/Phonology/Experiment images/';
...
var groups = [['a','b'],['a','c'],['a','d'],['b','c'],['b','d'],['c','d']]
...
/* Counterbalance */
var condition,sessionBalance,testOption, groupID;//encode and test response mapping
...
function generatePairs(arr1, arr2){
    // same-within-category same-across-category diff-within-category diff-across-category;
    // combo1 = ['SS','LL','SL','LS'];
    // combo2 = ['SS','LL','LS','SL'];
    // combo3 = ['LL','SS','SL','LS'];
    // combo4 = ['LL','SS','LS','SL'];
    //2 consitions: arr1arr1,arr1arr2,arr2arr2,arr2arr1 or arr1arr1,arr2arr1,arr2arr2,arr1arr2
    var assign = getRandomInt(2) //determine the condition
    ...
    var pairCombo = []; // define the variable for output
    switch(getRandomInt(4)){
        case 1:
            pairCombo = assign == 1?[smallArr1[0]+smallArr1[1], largeArr1[0]+largeArr2[0], smallArr2[0]+largeArr2[1], largeArr1[1]+smallArr2[1]]:[smallArr1[0]+smallArr1[1], largeArr2[0]+largeArr1[0], smallArr2[0]+largeArr2[1], largeArr2[1]+smallArr2[1]]
    }
