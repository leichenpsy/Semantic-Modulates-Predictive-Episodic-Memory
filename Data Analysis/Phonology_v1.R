...
coverTaskAcc$acc > 0.87 + 3*0.06
listSE <- coverTaskAcc$acc < 0.87 - 3*0.06
...
hit_0_subject <- c(2,3,6,7,8, 10, 13, 14,15, 20, 21, 22, 24, 30, 41, 45, 46, 47)
