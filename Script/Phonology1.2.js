...
function predictTestTrials(){
    if(DEBUG == 0){
        ...
        if(currTrial == 2 && picIndex == 0 && !breakOption){
            $('#predictTestTrialInstruction').hide();
            console.log('begin predict test break')
            sequenceBreak('predictTest')
        }
        else if(currTrial == 2 && picIndex == 0 && breakOption){
...
//         // add subject ID as column
            jsPsych.data.addProperties({subject: participantID, expStartTime: begin_time, expEndTime: end_time});
